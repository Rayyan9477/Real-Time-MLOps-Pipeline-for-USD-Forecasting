...
class ModelTrainer:
    ...
    def load_latest_data() -> pd.DataFrame:
        ...
        try:
            ...
            logger.warning(f"Failed to load from MinIO: {e}. Loading from local storage.")
    ...
    def prepare_features_target(
        ...
        exclude_cols = [
            ...
            'open', 'high', 'low', 'close'  # Keep only engineered features
        ]
    ...
    def detect_drift(
        ...
        logger.info(f"Drift detected in {len(drifted_features)}/{len(X_train.columns)} features")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train USD volatility prediction model")
